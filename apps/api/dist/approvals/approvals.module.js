...
exports.ApprovalsModule = ApprovalsModule = __decorate([
    (0, common_1.Module)({
        providers: [approvals_service_1.ApprovalsService, approvals_repository_1.ApprovalsRepository],
        exports: [approvals_service_1.ApprovalsService, approvals_repository_1.ApprovalsRepository],
    })
], ApprovalsModule);
