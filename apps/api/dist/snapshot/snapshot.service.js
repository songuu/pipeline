...
exports.resolveStageRunAfter = exports.DEFAULT_STAGE_DAG = exports.SnapshotService = void 0;
...
exports.DEFAULT_STAGE_DAG = shared_1.DEFAULT_STAGE_DAG;
exports.resolveStageRunAfter = shared_1.resolveStageRunAfter;
function buildTaskGraph(pipeline, params, workspaces) {
    const stageSet = new Set(pipeline.stages);
    return pipeline.stages.map((stage) => ({
        name: stage,
        taskRef: `${stage}-task`,
        runAfter: (0, exports.resolveStageRunAfter)(stage, stageSet),
